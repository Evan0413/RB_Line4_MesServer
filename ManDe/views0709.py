        ...
        try:
            ...
            if data:
                ...
                if data:
                    ...
                    Pass_num = int(result[0]['Pass'])
                    SQL = "SELECT Fail FROM model_tab WHERE gp_model = '" + cache.get('current_model') + "'"
                    print(SQL)
                    result = SQL_function3(SQL)
                    Fail_num = int(result[0]['Fail'])
...
def ProInfo_sta(request):
    ...
    try:
        ...
        all_tab_data_bucket = {'st01':{},'st02':{},'st03':{},'st04':{},'st05':{},'st06':{},'st07':{},'st08':{},'st09':{},'st10':{},'st11':{},'st12':{},'st13':{},'sp20':{},'sp21':{}}        #分别存储各个表的数据
        code_name = ['qr_code1','pcba_code1','qr_code2','pcba_code2']
...
async def ProInfo_time(request):
    ...
    try:
        ...
        ret_data = {}
        data = []
        test_tab_name = ['st01','st02','st03','st04','st05','st06','st07','st08','st09','st10','st11','st12','st13']
        all_tab_data_bucket = {'st01':{},'st02':{},'st03':{},'st04':{},'st05':{},'st06':{},'st07':{},'st08':{},'st09':{},'st10':{},'st11':{},'st12':{},'st13':{}}        #分别存储各个表的数据



        #顺序很重要，遵守当前线体主码可能出现的顺序
        code_name = ['qr_code1','pcba_code1','pcba_code2','qr_code2']
        if way == "":
            for it in test_tab_name:
                data_tag = False
                for it2 in code_name:
...
def ToStation(request):
    ...
    try:
        ...
        back_data = eval(GetOnline(request).content)
